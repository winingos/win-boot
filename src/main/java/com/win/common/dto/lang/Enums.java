...
public class Enums {
     ...
     */
    public static <T extends com.win.common.dto.lang.EnumValueSupport> T valueOf(Class<T> enumClass, int value) {
    ...
    public static <T extends com.win.common.dto.lang.EnumValueSupport> T valueOf(Class<T> enumClass, int value, boolean throwIfUndefined) {
     ...
     * @return
     */
    public static <T extends com.win.common.dto.lang.EnumValueSupport> boolean isDefined(Class<T> enumClass, int value) {
        Map<Integer, Object> map = getValues(enumClass);
     ...
     * @return
     */
    public static <T extends com.win.common.dto.lang.EnumDisplayNameSupport & com.win.common.dto.lang.EnumValueSupport> String displayName(Class<T> enumClass, int value) {
