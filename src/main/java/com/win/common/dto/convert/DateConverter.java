package com.win.common.dto.convert;
...
public final class DateConverter {
    ...
    private static Format DEFAULT_OLD_FORMATTER = DEFAULT_NEW_FORMATTER.toFormat();
     ...
     */
    public static final long EPOCH_NET_TICKS = 621355968000000000L;
    // TODO: to check!!! hour = 8 ???
    public static final LocalDateTime EPOCH_DATE_TIME = LocalDateTime.of(1970, 1, 1, 8, 0, 0, 0);//  ZonedDateTime.of(1970, 1, 1, 0, 0, 0, 0, ZoneId.systemDefault()).toLocalDateTime();
    /**
     * UNIX 時間戳當天0點0分0秒
     */
